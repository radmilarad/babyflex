#!/usr/bin/env python3
"""
Step 4: Evaluation – Metriken (R², MAE, RMSE, CV) + optional SHAP
==================================================================

Bewertet die trainierten Modelle auf den Features, optional SHAP-Analyse.

Aus Projektroot:  python 2_ml/4_evaluate_models.py
"""
import sys
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Step 4: Evaluate battery benefit models")
